...
See the [policy.algorithms.image_classifier_test][] module for an example of how to use this.
"""
...
from policy.conftest import DEFAULT_SEED
...
class LightningModuleTests(Generic[LightningModuleType], ABC):
    ...
    See the [policy.algorithms.image_classifier_test][] module for an example.
