...
from policy.datamodules.image_classification.image_classification import (
    ImageClassificationDataModule,
)
from policy.main_test import experiment_commands_to_test
from policy.utils.env_vars import SLURM_JOB_ID
from policy.utils.testutils import IN_GITHUB_CI, run_for_all_configs_of_type
...
class TestImageClassifier(LightningModuleTests[ImageClassifier]):
    ...
    - `algorithm_config` will take the value `"image_classifier"`
        - This is because there is an `image_classifier.yaml` config file in policy/configs/algorithms
